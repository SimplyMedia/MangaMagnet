...
{
    [DbContext(typeof(MangaMagnetDatabaseContext))]
    partial class MangaMagnetDatabaseContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "manga_status", new[] { "on_going", "completed", "cancelled", "on_hold" });
            ...
            modelBuilder.Entity("MangaMagnet.Core.Database.ChapterMetadata", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("LocalVolumeId")
                        .HasColumnType("uuid")
                        .HasColumnName("local_volume_id");

                    b.Property<Guid>("MangaId")
                        .HasColumnType("uuid")
                        .HasColumnName("manga_id");

                    b.Property<Guid?>("MangaMetadataId")
                        .HasColumnType("uuid")
                        .HasColumnName("manga_metadata_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_chapter_metadata");

                    b.HasIndex("LocalVolumeId")
                        .HasDatabaseName("ix_chapter_metadata_local_volume_id");

                    b.HasIndex("MangaMetadataId")
                        .HasDatabaseName("ix_chapter_metadata_manga_metadata_id");

                    b.ToTable("chapter_metadata", (string)null);
                });

            modelBuilder.Entity("MangaMagnet.Core.Database.LocalChapter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("LocalMangaId")
                        .HasColumnType("uuid")
                        .HasColumnName("local_manga_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_local_chapters");

                    b.HasIndex("LocalMangaId")
                        .HasDatabaseName("ix_local_chapters_local_manga_id");

                    b.HasIndex("MetadataId")
                        .HasDatabaseName("ix_local_chapters_metadata_id");

                    b.ToTable("local_chapters", (string)null);
                });

            modelBuilder.Entity("MangaMagnet.Core.Database.LocalManga", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_local_mangas");

                    b.HasIndex("MetadataId")
                        .HasDatabaseName("ix_local_mangas_metadata_id");

                    b.ToTable("local_mangas", (string)null);
                });

            modelBuilder.Entity("MangaMagnet.Core.Database.LocalVolume", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_local_volumes");

                    b.HasIndex("LocalMangaId")
                        .HasDatabaseName("ix_local_volumes_local_manga_id");

                    b.ToTable("local_volumes", (string)null);
                });

            modelBuilder.Entity("MangaMagnet.Core.Database.MangaMetadata", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("MangaDexId")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("manga_dex_id");

                    b.Property<string>("MangaUpdatesId")
                        .HasColumnType("text")
                        .HasColumnName("manga_updates_id");

                    b.Property<long?>("MyAnimeListId")
                        .HasColumnType("bigint")
                        .HasColumnName("my_anime_list_id");

                    b.Property<MangaStatus>("Status")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_manga_metadata");

                    b.HasIndex("MangaDexId")
                        .IsUnique()
                        .HasDatabaseName("ix_manga_metadata_manga_dex_id");

                    b.ToTable("manga_metadata", (string)null);
                });
            ...
            modelBuilder.Entity("MangaMagnet.Core.Database.ChapterMetadata", b =>
                {
                    b.HasOne("MangaMagnet.Core.Database.LocalVolume", null)
                        .WithMany("ChapterMetadata")
                        .HasForeignKey("LocalVolumeId")
                        .HasConstraintName("fk_chapter_metadata_local_volumes_local_volume_id");

                    b.HasOne("MangaMagnet.Core.Database.MangaMetadata", null)
                        .WithMany("ChapterMetadata")
                        .HasForeignKey("MangaMetadataId")
                        .HasConstraintName("fk_chapter_metadata_manga_metadata_manga_metadata_id");
                });

            modelBuilder.Entity("MangaMagnet.Core.Database.LocalChapter", b =>
                {
                    b.HasOne("MangaMagnet.Core.Database.LocalManga", "LocalManga")
                        .WithMany("Chapters")
                        .HasForeignKey("LocalMangaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_local_chapters_local_mangas_local_manga_id");

                    b.HasOne("MangaMagnet.Core.Database.ChapterMetadata", "Metadata")
                        .WithMany()
                        .HasForeignKey("MetadataId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_local_chapters_chapter_metadata_metadata_id");

                    b.Navigation("LocalManga");
            ...
            modelBuilder.Entity("MangaMagnet.Core.Database.LocalManga", b =>
                {
                    b.HasOne("MangaMagnet.Core.Database.MangaMetadata", "Metadata")
                        .WithMany()
                        .HasForeignKey("MetadataId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_local_mangas_manga_metadata_metadata_id");
            ...
            modelBuilder.Entity("MangaMagnet.Core.Database.LocalVolume", b =>
                {
                    b.HasOne("MangaMagnet.Core.Database.LocalManga", "LocalManga")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_local_volumes_local_mangas_local_manga_id");
